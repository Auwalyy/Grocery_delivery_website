        ...
        {myOrders.map((order, index) => (
            <div key={index} className='border border-gray-300 rounded-lg p-4 mb-10 max-w-4xl'>
                ...
                {order.items.map((item, index) => (
                    <div className={`
                    relative bg-white text-gray-500/70 ${order.items.lenght !== index + 1 && "border-b"} 
                    border-gray-300 flex flex-col md:flex-row items-center justify-between p-4 py-5 md:gap-16 w-full max-w-4xl`} key={index}>
                        ...
                        <div className='flex flex-col justify-center md:ml-8 mb-4 md:mb-0'>
                            ...
                            <p>Dates: {new Date(order.createdAt).toLocaleDateString()}</p>
                        </div>
